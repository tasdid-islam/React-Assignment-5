              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    disabled={isAdded}
                    className={`mt-5 w-full rounded-[30px] py-2 text-sm font-medium text-white transition ${
                      isAdded
                        ? "cursor-not-allowed bg-gray-400"
                        : "bg-[#110a0d] hover:bg-[#DB2777]"
                    }`}
                  >
                    {isAdded
                      ? "✓ Added to Stack"
            ...
            {selectedStack.length === 0 ? (
              ...
              <div className="mt-5 space-y-3">
                ...
                {selectedStack.map((item) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="text-lg font-bold text-[#DB2777] transition hover:scale-110"
                ...
                <button
                  ...
                  className="mt-5 w-full rounded-[30px] bg-[#110a0d] py-2 text-sm font-medium text-white transition hover:bg-[#DB2777]"
                >
                  Remove All
                </button>
